...
@Observable
class SpeechRecognitionController: NSObject, AVAudioRecorderDelegate {
    ...
    private var speechRecognizer: SFSpeechRecognizer? // SFSpeechRecognizer instance for speech recognition
